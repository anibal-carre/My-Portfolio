export const languageTexts = {
  en: {
    ...
    courses: {
      courses: "Courses",
      title1: "Fullstack Developer | Funval International",
      title2: "Systems analysis and development | Cruzeiro do Sul - Brazil",
      title3: "Seller course | Senac Brazil",
      content1:
  ...
  pt: {
    myInfo: {
      ...
      i: "Sou um",
      dev: "Desenvolvedor",
      student: "Estudante de Tecnologia",
      cod: "Codificador",
  ...
  es: {
    myInfo: {
      ...
      i: "Soy un",
      dev: "Desarrollador",
      student: "Estudiante de Tecnología",
      cod: "Codificador",
